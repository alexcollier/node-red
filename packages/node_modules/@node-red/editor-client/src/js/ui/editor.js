...
RED.editor = (function() {
    ...
    var _lockHeartbeatInterval = null;
    ...
    function showEditDialog(node, defaultTab) {
        ...
        // Live editing: request node lock before opening editor
        if (RED.liveSync && RED.liveSync.isActive() && node.id) {
            RED.comms.send("multiplayer/lock-request", { nodeId: node.id, action: "acquire" });
        }
        ...
        var trayOptions = {
            ...
            close: function() {
                ...
                if (editing_node) {
                    ...
                    // Live editing: release node lock
                    if (RED.liveSync && RED.liveSync.isActive() && editing_node.id) {
                        RED.comms.send("multiplayer/lock-request", { nodeId: editing_node.id, action: "release" });
                        if (_lockHeartbeatInterval) {
