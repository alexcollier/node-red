...
module.exports = function(RED) {
    ...
    // Shared sandbox base - read-only properties identical across all function node instances.
    // Each node creates a lightweight Object.create(sharedSandboxBase) instead of duplicating these.
    var sharedSandboxBase = {
        console: console,
        util: util,
        Buffer: Buffer,
        URL: URL,
    ...
    if (util.hasOwnProperty('promisify')) {
        sharedSandboxBase.promisify = util.promisify;
    }
    ...
    function FunctionNode(n) {
        ...
        var sandbox = Object.create(sharedSandboxBase);
        sandbox.RED = {
            util: Object.create(RED.util, {
                getSetting: {
                    value: function (_node, name, _flow) {
        ...
        if (node.hasOwnProperty("libs")) {
            ...
            modules.forEach(module => {
                ...
                if (vname && (vname !== "")) {
                    if ((vname in sandbox) || vname === 'node') {
